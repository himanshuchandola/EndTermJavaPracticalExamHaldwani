...
b1.addActionListener(this); // first button event
b2.addActionListener(this); // second button event
b3.addActionListener(this); // third button event
b4.addActionListener(this); // fourth button event
}
